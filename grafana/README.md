...
- You need query planning duration percentiles (p50, p95, p99) and wait time monitoring
...
- You want compute job monitoring (query parsing, queued jobs, job counts by outcome)
