...
GRAIL_FILES = [
    ...
    # Generated by generate-summary-variants.py — do not edit by hand
    "dashboard-template-grail-summary.json",
    "dashboard-template-grail-configurable-summary.json",
    "mcp-server-template-grail-summary.json",
]
CLASSIC_FILES = [
